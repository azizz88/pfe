...
foreach ($service in $services) {
    ...
    Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$servicePath'; $javaConfig & 'C:\Program Files\Apache\maven\bin\mvn.cmd' spring-boot:run"
}
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$gatewayPath'; $javaConfig & 'C:\Program Files\Apache\maven\bin\mvn.cmd' spring-boot:run"
